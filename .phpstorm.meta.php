...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\ScheduleRepository' => \App\Repositories\EloquentScheduleRepository::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./srv/http/schedule-bot/public/storage' => 'string',
            ...
            'nutgram.token' => 'string',
            'nutgram.safe_mode' => 'boolean',
            'nutgram.config.api_url' => 'string',
            'nutgram.routes' => 'boolean',
            'nutgram.mixins' => 'boolean',
            'nutgram.namespace' => 'string',
            'nutgram.log_channel' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./srv/http/schedule-bot/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'nutgram.token','nutgram.safe_mode','nutgram.config.api_url','nutgram.routes','nutgram.mixins',
'nutgram.namespace','nutgram.log_channel','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'messages.Homework.daily_homework_view','messages.Homework.weekly_homework_view','messages.Schedule.weekday_schedule_preview','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'laravel-exceptions::503','laravel-exceptions::layout','laravel-exceptions::minimal','logging::request','logging::response',
...
'terminal::fail','terminal::list','terminal::success','terminal::table',);
...
'validation.custom.attribute-name.rule-name','button_labels.keyboard.next_monday','button_labels.keyboard.next_tuesday','button_labels.keyboard.next_wednesday','button_labels.keyboard.next_thursday',
'button_labels.keyboard.next_friday','button_labels.keyboard.next_saturday','button_labels.keyboard.custom','button_labels.keyboard.tomorrow','button_labels.keyboard.this_week',
'button_labels.keyboard.next_week','button_labels.role.student','button_labels.role.teacher','button_labels.role.onduty','button_labels.role.admin',
'button_labels.general.no_name','button_labels.schedule.done','button_labels.schedule.confirm_yes','button_labels.schedule.confirm_no','command_descriptions.cmd.start',
'command_descriptions.cmd.cancel','command_descriptions.cmd.newclass','command_descriptions.cmd.newclass_step','command_descriptions.cmd.joinclass','command_descriptions.cmd.joinclass_step',
'command_descriptions.cmd.deleteclass','command_descriptions.cmd.changerole','command_descriptions.cmd.changerole_step','command_descriptions.cmd.leaveclass','command_descriptions.cmd.newhomework',
'command_descriptions.cmd.deletehomework','command_descriptions.cmd.showhomework','command_descriptions.cmd.newsubject','command_descriptions.cmd.deletesubject','error.class.already_member',
'error.class.already_has_class_link','error.class.not_found','error.class.not_found_try_again','error.class.not_found_with_token','error.class.create_error',
'error.class.join_error','error.class.not_member','error.class.server_error','error.class.no_members','error.class.no_subjects',
'error.class.no_permission','error.role.self_change','error.role.invalid','error.role.invalid_short','error.role.not_in_class',
'error.role.user_not_found','error.role.example','error.homework.not_in_class','error.homework.no_permission','error.homework.not_found',
'error.homework.not_found_class','error.homework.none_in_period','error.homework.description_too_short','error.homework.date_empty','error.homework.date_invalid',
'error.homework.description_empty','error.subject.name_empty','error.subject.name_too_short','error.subject.already_exists','error.subject.not_found',
'error.cancel.no_active','error.server.error','error.empty','error.try_again','general.weekday.1',
'general.weekday.2','general.weekday.3','general.weekday.4','general.weekday.5','general.weekday.6',
'general.weekday.7','general.name','general.yes','general.no','info.class.created',
'info.class.joined','info.class.left','info.class.deleted','info.class.deleted_broadcast','info.role.changed',
'info.role.changed_to','info.homework.created','info.homework.deleted','info.homework.view_header','info.homework.view_header_range',
'info.homework.no_homework','info.homework.view_item','info.homework.view_day','info.subject.created','info.subject.deleted',
'info.cancel.done','info.schedule.created','info.schedule.recreating','prompt.general.welcome','prompt.general.click_button',
'prompt.general.enter_date_text','prompt.general.done','prompt.general.marked','prompt.class.enter_name','prompt.class.name_invalid',
'prompt.class.enter_token','prompt.class.token_empty','prompt.class.token_invalid','prompt.role.select_user','prompt.role.select_role',
'prompt.homework.select_date','prompt.homework.select_period','prompt.homework.enter_date_format','prompt.homework.enter_description','prompt.homework.select_for_delete',
'prompt.homework.select_subject','prompt.subject.enter_name','prompt.subject.name_invalid','prompt.subject.select_for_delete','prompt.subject.marked',
'prompt.schedule.select_weekdays','prompt.schedule.select_subjects','prompt.schedule.creating_schedule','prompt.schedule.confirm_schedule','prompt.schedule.schedule_preview',
'prompt.schedule.no_lessons','prompt.schedule.should_have_workdays',);
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','TELEGRAM_TOKEN','TELEGRAM_API_URL',);
